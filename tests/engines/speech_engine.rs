...
fn speech_engine_harmonics() {
    ...
    write_wav("engines/speech/speech_harmonics.wav", &wav_data).ok();
    write_wav("engines/speech/speech_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn speech_engine_timbre() {
    ...
    write_wav("engines/speech/speech_timbre.wav", &wav_data).ok();
    write_wav("engines/speech/speech_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn speech_engine_morph() {
    ...
    write_wav("engines/speech/speech_morph.wav", &wav_data).ok();
    write_wav("engines/speech/speech_morph_aux.wav", &wav_data_aux).ok();
}
