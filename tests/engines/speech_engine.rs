...
fn speech_engine_harmonics() {
    ...
    wav_writer::write("engines/speech/speech_harmonics.wav", &wav_data).ok();
    wav_writer::write("engines/speech/speech_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn speech_engine_timbre() {
    ...
    wav_writer::write("engines/speech/speech_timbre.wav", &wav_data).ok();
    wav_writer::write("engines/speech/speech_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn speech_engine_morph() {
    ...
    wav_writer::write("engines/speech/speech_morph.wav", &wav_data).ok();
    wav_writer::write("engines/speech/speech_morph_aux.wav", &wav_data_aux).ok();
}
