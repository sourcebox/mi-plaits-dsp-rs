...
fn snare_drum_engine_harmonics() {
    let mut engine = snare_drum_engine::SnareDrumEngine::new(&std::alloc::System, BLOCK_SIZE);
    ...
    wav_writer::write("engines/snare_drum/snare_drum_harmonics.wav", &wav_data).ok();
    wav_writer::write(
...
fn snare_drum_engine_timbre() {
    ...
    wav_writer::write("engines/snare_drum/snare_drum_timbre.wav", &wav_data).ok();
    wav_writer::write(
...
fn snare_drum_engine_morph() {
    ...
    wav_writer::write("engines/snare_drum/snare_drum_morph.wav", &wav_data).ok();
    wav_writer::write("engines/snare_drum/snare_drum_morph_aux.wav", &wav_data_aux).ok();
}
