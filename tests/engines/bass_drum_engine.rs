...
fn bass_drum_engine_harmonics() {
    ...
    write_wav("engines/bass_drum/bass_drum_harmonics.wav", &wav_data).ok();
    write_wav(
...
fn bass_drum_engine_timbre() {
    ...
    write_wav("engines/bass_drum/bass_drum_timbre.wav", &wav_data).ok();
    write_wav("engines/bass_drum/bass_drum_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn bass_drum_engine_morph() {
    ...
    write_wav("engines/bass_drum/bass_drum_morph.wav", &wav_data).ok();
    write_wav("engines/bass_drum/bass_drum_morph_aux.wav", &wav_data_aux).ok();
}
