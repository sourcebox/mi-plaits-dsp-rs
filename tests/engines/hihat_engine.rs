...
fn hihat_engine_harmonics() {
    ...
    write_wav("engines/hihat/hihat_harmonics.wav", &wav_data).ok();
    write_wav("engines/hihat/hihat_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn hihat_engine_timbre() {
    ...
    write_wav("engines/hihat/hihat_timbre.wav", &wav_data).ok();
    write_wav("engines/hihat/hihat_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn hihat_engine_morph() {
    ...
    write_wav("engines/hihat/hihat_morph.wav", &wav_data).ok();
    write_wav("engines/hihat/hihat_morph_aux.wav", &wav_data_aux).ok();
}
