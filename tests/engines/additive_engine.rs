...
fn additive_engine_harmonics() {
    ...
    write_wav("engines/additive/additive_harmonics.wav", &wav_data).ok();
    write_wav("engines/additive/additive_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn additive_engine_timbre() {
    ...
    write_wav("engines/additive/additive_timbre.wav", &wav_data).ok();
    write_wav("engines/additive/additive_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn additive_engine_morph() {
    ...
    write_wav("engines/additive/additive_morph.wav", &wav_data).ok();
    write_wav("engines/additive/additive_morph_aux.wav", &wav_data_aux).ok();
}
