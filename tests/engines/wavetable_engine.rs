...
fn wavetable_engine_harmonics() {
    let mut engine = wavetable_engine::WavetableEngine::new(&std::alloc::System, BLOCK_SIZE);
    ...
    wav_writer::write("engines/wavetable/wavetable_harmonics.wav", &wav_data).ok();
    wav_writer::write(
...
fn wavetable_engine_timbre() {
    ...
    wav_writer::write("engines/wavetable/wavetable_timbre.wav", &wav_data).ok();
    wav_writer::write("engines/wavetable/wavetable_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn wavetable_engine_morph() {
    ...
    wav_writer::write("engines/wavetable/wavetable_morph.wav", &wav_data).ok();
    wav_writer::write("engines/wavetable/wavetable_morph_aux.wav", &wav_data_aux).ok();
}
