...
fn swarm_engine_harmonics() {
    ...
    write_wav("engines/swarm/swarm_harmonics.wav", &wav_data).ok();
    write_wav("engines/swarm/swarm_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn swarm_engine_timbre() {
    ...
    write_wav("engines/swarm/swarm_timbre.wav", &wav_data).ok();
    write_wav("engines/swarm/swarm_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn swarm_engine_morph() {
    ...
    write_wav("engines/swarm/swarm_morph.wav", &wav_data).ok();
    write_wav("engines/swarm/swarm_morph_aux.wav", &wav_data_aux).ok();
}
