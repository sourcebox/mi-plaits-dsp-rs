...
fn fm_engine_harmonics() {
    let mut engine = fm_engine::FmEngine::new(&std::alloc::System, BLOCK_SIZE);
    ...
    wav_writer::write("engines/fm/fm_harmonics.wav", &wav_data).ok();
    wav_writer::write("engines/fm/fm_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn fm_engine_timbre() {
    ...
    wav_writer::write("engines/fm/fm_timbre.wav", &wav_data).ok();
    wav_writer::write("engines/fm/fm_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn fm_engine_morph() {
    ...
    wav_writer::write("engines/fm/fm_morph.wav", &wav_data).ok();
    wav_writer::write("engines/fm/fm_morph_aux.wav", &wav_data_aux).ok();
}
