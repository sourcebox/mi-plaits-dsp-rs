...
fn modal_engine_harmonics() {
    ...
    write_wav("engines/modal/modal_harmonics.wav", &wav_data).ok();
    write_wav("engines/modal/modal_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn modal_engine_timbre() {
    ...
    write_wav("engines/modal/modal_timbre.wav", &wav_data).ok();
    write_wav("engines/modal/modal_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn modal_engine_morph() {
    ...
    write_wav("engines/modal/modal_morph.wav", &wav_data).ok();
    write_wav("engines/modal/modal_morph_aux.wav", &wav_data_aux).ok();
}
