...
fn modal_engine_harmonics() {
    let mut engine = modal_engine::ModalEngine::new(&std::alloc::System, BLOCK_SIZE);
    ...
    wav_writer::write("engines/modal/modal_harmonics.wav", &wav_data).ok();
    wav_writer::write("engines/modal/modal_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn modal_engine_timbre() {
    ...
    wav_writer::write("engines/modal/modal_timbre.wav", &wav_data).ok();
    wav_writer::write("engines/modal/modal_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn modal_engine_morph() {
    ...
    wav_writer::write("engines/modal/modal_morph.wav", &wav_data).ok();
    wav_writer::write("engines/modal/modal_morph_aux.wav", &wav_data_aux).ok();
}
