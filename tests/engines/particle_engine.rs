...
fn particle_engine_harmonics() {
    ...
    write_wav("engines/particle/particle_harmonics.wav", &wav_data).ok();
    write_wav("engines/particle/particle_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn particle_engine_timbre() {
    ...
    write_wav("engines/particle/particle_timbre.wav", &wav_data).ok();
    write_wav("engines/particle/particle_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn particle_engine_morph() {
    ...
    write_wav("engines/particle/particle_morph.wav", &wav_data).ok();
    write_wav("engines/particle/particle_morph_aux.wav", &wav_data_aux).ok();
}
