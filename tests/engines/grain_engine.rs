...
fn grain_engine_harmonics() {
    ...
    write_wav("engines/grain/grain_harmonics.wav", &wav_data).ok();
    write_wav("engines/grain/grain_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn grain_engine_timbre() {
    ...
    write_wav("engines/grain/grain_timbre.wav", &wav_data).ok();
    write_wav("engines/grain/grain_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn grain_engine_morph() {
    ...
    write_wav("engines/grain/grain_morph.wav", &wav_data).ok();
    write_wav("engines/grain/grain_morph_aux.wav", &wav_data_aux).ok();
}
