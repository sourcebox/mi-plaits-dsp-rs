...
fn noise_engine_harmonics() {
    let mut engine = noise_engine::NoiseEngine::new(&std::alloc::System, BLOCK_SIZE);
    ...
    wav_writer::write("engines/noise/noise_harmonics.wav", &wav_data).ok();
    wav_writer::write("engines/noise/noise_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn noise_engine_timbre() {
    ...
    wav_writer::write("engines/noise/noise_timbre.wav", &wav_data).ok();
    wav_writer::write("engines/noise/noise_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn noise_engine_morph() {
    ...
    wav_writer::write("engines/noise/noise_morph.wav", &wav_data).ok();
    wav_writer::write("engines/noise/noise_morph_aux.wav", &wav_data_aux).ok();
}
