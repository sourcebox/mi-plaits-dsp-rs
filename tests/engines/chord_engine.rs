...
fn chord_engine_harmonics() {
    ...
    write_wav("engines/chord/chord_harmonics.wav", &wav_data).ok();
    write_wav("engines/chord/chord_harmonics_aux.wav", &wav_data_aux).ok();
}
...
fn chord_engine_timbre() {
    ...
    write_wav("engines/chord/chord_timbre.wav", &wav_data).ok();
    write_wav("engines/chord/chord_timbre_aux.wav", &wav_data_aux).ok();
}
...
fn chord_engine_morph() {
    ...
    write_wav("engines/chord/chord_morph.wav", &wav_data).ok();
    write_wav("engines/chord/chord_morph_aux.wav", &wav_data_aux).ok();
}
